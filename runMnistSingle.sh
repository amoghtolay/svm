...
#Change these values
trainingFileName='mnist.scale'
testingFileName='mnist.scale.t'
modelFileNamePrefix='mnist-scale.model.'
outputFileNamePrefix='mnist-out.'
scaleRangeFile='../rangeMnist'
folderName='mnist'
#changes till here only

rm -vf GLPK_Files/one-vs-one/hyperplaneClass_glpk
rm -vf GLPK_Files/one-vs-one/accuracy_glpk
rm -v GLPK_Files/one-vs-one/margin_glpk
rm -vf GLPK_Files/one-vs-one/spans_glpk
rm -vf GLPK_Files/one-vs-one/nSV_glpk
mv -vf GLPK_Files/one-vs-one/crossEfficiency_glpk.txt GLPK_Files/one-vs-one/crossEfficiency_glpk.allhyper.txt
rm -vf GLPK_Files/one-vs-one/output_efficiencies.vsone.txt
rm -vf GLPK_Files/one-vs-one/avg_efficiencies.vsone.txt

rm -vf GLPK_Files/one-vs-all/hyperplaneClass_glpk
rm -vf GLPK_Files/one-vs-all/accuracy_glpk
rm -vf GLPK_Files/one-vs-all/margin_glpk
rm -vf GLPK_Files/one-vs-all/spans_glpk
rm -vf GLPK_Files/one-vs-all/nSV_glpk
mv -vf GLPK_Files/one-vs-all/crossEfficiency_glpk.txt GLPK_Files/one-vs-all/crossEfficiency_glpk.allhyper.txt
rm -vf GLPK_Files/one-vs-all/output_efficiencies.vsall.txt

rm -vf GLPK_Files/dense/hyperplaneClass_glpk
rm -vf GLPK_Files/dense/accuracy_glpk
rm -vf GLPK_Files/dense/margin_glpk
rm -vf GLPK_Files/dense/spans_glpk
rm -vf GLPK_Files/dense/nSV_glpk
mv -vf GLPK_Files/dense/crossEfficiency_glpk.txt GLPK_Files/dense/crossEfficiency_glpk.allhyper.txt
rm -vf GLPK_Files/dense/output_efficiencies.dense.txt

rm -vf GLPK_Files/sparse/hyperplaneClass_glpk
rm -vf GLPK_Files/sparse/accuracy_glpk
rm -vf GLPK_Files/sparse/margin_glpk
rm -vf GLPK_Files/sparse/spans_glpk
rm -vf GLPK_Files/sparse/nSV_glpk
mv -vf GLPK_Files/sparse/crossEfficiency_glpk.txt GLPK_Files/sparse/crossEfficiency_glpk.allhyper.txt
rm -vf GLPK_Files/sparse/output_efficiencies.sparse.txt
...
./svm-train ${trainingFilePath}${trainingFileName} ${modelFilePath}${modelFileName}
...
./svm-train -i 1 ${trainingFilePath}${trainingFileName} ${modelFilePath}${modelFileName}
#Moving all GLPK files to one-vs-one folder
...
./svm-train -i 2 ${trainingFilePath}${trainingFileName} ${modelFilePath}${modelFileName}
#Moving all GLPK files to one-vs-one folder
...
modelFileName=${modelFileNamePrefix}${fileNameMethod}
#Running training dense
./svm-train -i 3 ${trainingFilePath}${trainingFileName} ${modelFilePath}${modelFileName}
#Moving all GLPK files to one-vs-one folder
