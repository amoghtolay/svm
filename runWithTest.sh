...
rm -v GLPK_Files/one-vs-one/crossEfficiency_glpk.txt
...
rm -v GLPK_Files/one-vs-all/crossEfficiency_glpk.txt
...
rm -v GLPK_Files/dense/crossEfficiency_glpk.txt
...
rm -v GLPK_Files/sparse/crossEfficiency_glpk.txt
...
paste -d : output_efficiencies.vsone.txt crossEfficiency_glpk.txt testAccuracy.txt > ../../comparisons/${folderName}/one-vs-one/finalData-one-vs-one.txt
...
paste -d : output_efficiencies.vsall.txt crossEfficiency_glpk.txt testAccuracy.txt > ../../comparisons/${folderName}/one-vs-all/finalData-one-vs-all.txt
...
paste -d : output_efficiencies.dense.txt crossEfficiency_glpk.txt testAccuracy.txt > ../../comparisons/${folderName}/dense/finalData-dense.txt
...
paste -d : output_efficiencies.sparse.txt crossEfficiency_glpk.txt testAccuracy.txt > ../../comparisons/${folderName}/sparse/finalData-sparse.txt
